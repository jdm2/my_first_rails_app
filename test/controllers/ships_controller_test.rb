...
class ShipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ship" do
    assert_difference('Ship.count') do
      post ships_url, params: { ship: { make: @ship.make, model: @ship.model, year: @ship.year } }
    end
  ...
  test "should update ship" do
    patch ship_url(@ship), params: { ship: { make: @ship.make, model: @ship.model, year: @ship.year } }
